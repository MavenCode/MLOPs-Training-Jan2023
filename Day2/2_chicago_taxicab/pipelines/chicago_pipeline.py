...
COMPONENT_URL = 'https://raw.githubusercontent.com/MavenCode/MLOpsTraining-Dec2022/master/Day2/4_chicago_taxicab/components'
...
catboost_train_classifier_op = components.load_component_from_url(f'{COMPONENT_URL}/Train_classifier/from_CSV/component.yaml')
catboost_train_regression_op = components.load_component_from_url(f'{COMPONENT_URL}/Train_regression/from_CSV/component.yaml')
catboost_predict_classes_op = components.load_component_from_url(f'{COMPONENT_URL}/Predict_classes/from_CSV/component.yaml')
catboost_predict_values_op = components.load_component_from_url(f'{COMPONENT_URL}/Predict_values/from_CSV/component.yaml')
catboost_predict_class_probabilities_op = components.load_component_from_url(f'{COMPONENT_URL}/Predict_class_probabilities/from_CSV/component.yaml')
catboost_to_apple_op = components.load_component_from_url(f'{COMPONENT_URL}/convert_CatBoostModel_to_AppleCoreMLModel/component.yaml')
catboost_to_onnx_op = components.load_component_from_url(f'{COMPONENT_URL}/convert_CatBoostModel_to_ONNX/component.yaml')
